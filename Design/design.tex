...
INSERT INTO Meetings(OwnerID, Title, ISOTime, Location, Attendees) VALUES({0});
SELECT * FROM Meetings {0};
SELECT * FROM MeetingAttendee WHERE (UserID = {0} AND Confirmed = 0);
SELECT MeetingID FROM Meetings {0};
INSERT INTO MeetingAttendee(MeetingID, UserID, Confirmed) VALUES({0});
SELECT UserID FROM MeetingAttendee WHERE (MeetingID = {0})
UPDATE MeetingAttendee SET Confirmed = 1 WHERE {0}
UPDATE MeetingAttendee SET Confirmed = 0 WHERE {0}
DELETE FROM MeetingAttendee WHERE {0}

SELECT * FROM Tasks {0};

SELECT TaskID FROM Tasks {0};
INSERT INTO Tasks(Title, Description, Owner, Attendees) VALUES({0});
SELECT Name FROM Users WHERE(UserID = {0})
